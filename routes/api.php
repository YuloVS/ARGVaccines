...
use App\Http\Controllers\API\v1\AggregatedByGenderController;
...
use App\Http\Controllers\API\v1\AggregatedByVaccinationDateController;
...
use App\Http\Controllers\API\v1\VaccineQuantityController;
